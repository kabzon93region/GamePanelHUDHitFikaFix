...
`\\Servant\data\Games\EscapeFromTarkov4\CURSORAIMODING\releases\GamePanelHUDHitFikaFix_(headless_client)_v1.0.0_2026-06-26.zip`

```powershell
gh release create v1.0.0 "\\Servant\data\Games\EscapeFromTarkov4\CURSORAIMODING\releases\GamePanelHUDHitFikaFix_(headless_client)_v1.0.0_2026-06-26.zip" ^
